...
export const ProjectCard = component$<ProjectCardProps>(({ project }) => {
  return (
    <div class="card-hover rounded-3xl overflow-hidden border border-white border-opacity-10 shadow-2xl">
      <div
        class={`h-72 bg-gradient-to-br ${project.gradient} flex items-center justify-center relative overflow-hidden`}
      >
        ...
        <div class="text-white text-center relative z-10">
          ...
          <p class="text-base opacity-90 font-light tracking-wide">
            {project.category}
          </p>
        </div>
      </div>
      <div class="p-10">
        <h3 class="text-3xl font-light mb-6 text-gray-100 tracking-wide">
          {project.title}
        </h3>
