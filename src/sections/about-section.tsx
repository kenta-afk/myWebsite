    ...
    <section id="about" class="section-bg py-32">
      <Container>
        <Card variant="glass" class="p-16 mb-16">
          <h2 class="text-4xl font-light text-white mb-12 text-center tracking-wide">
            About Me
          </h2>
          <div class="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-6">
              {socialLinks.map((link) => (
                ...
                >
                  <div
                    class={`w-14 h-14 ${link.bgColor} rounded-xl flex items-center justify-center mr-6 shadow-lg`}
                  >
                    <svg
                  ...
                  <div>
                    <h3 class="font-medium text-white group-hover:text-violet-200 text-lg">
                      {link.name}
                    </h3>
                  </div>
                </a>
