...
export const featuredProjects: Project[] = [
  {
    id: "setsuna",
    title: "刹那",
    description: "人とマッチングして素早くスマートフォンを振る反射神経ゲーム。LINEふるふるを彷彿とさせる懐かしいマッチング方式で、星のカービィーの刹那の見斬りを再現。",
    technologies: ["Swift", "Vapor", "GraphQL", "Apollo Server", "Go", "Docker"],
  ...
  },
  {
    id: "binary-mahjong",
    title: "バイナリ麻雀",
    description: "麻雀に使用される数字やマークをすべてバイナリで表示する革新的な麻雀ゲーム。バイナリ表記故の難読性を活かしたダウト機能を実装し、新しい楽しさを提供。",
    technologies: ["Python", "React", "Docker", "WebSocket", "MySQL", "TypeScript"],
  ...
  },
  {
    ...
    description: "お客さんの要望に応じたAWSのアーキテクチャを作るゲーム。直感的にUIでアーキテクチャ図を作成でき、花火を上げることも可能。Terraformを使用した完全なIaC化を実現。",
    technologies: ["AWS", "Terraform", "Vue.js", "Vuetify", "FastAPI", "DynamoDB"],
